...
function enableMobileSliders() {
    enableModileSlider('butter');
    enableModileSlider('sugar');
}

function enableModileSlider(type) {
    // Create nav pills
    $('#slider-'+type)
        .hide()
    ...
    // Control on click action, change active class, set value to input
    $('.m-slider-'+type+' a').click(function () {
        $('.m-slider-'+type+' li').removeClass('active');
        $(this).closest('li').addClass('active');
        
        var value = $(this).data(type);
        $('#slider-'+type).val(value);
        return false;
    });
    
    // Set active class on current value on load
    var value = $('#slider-'+type).val();
    $('.m-slider-'+type+' a[data-'+type+'="'+value+'"]').closest('li').addClass('active');
}
